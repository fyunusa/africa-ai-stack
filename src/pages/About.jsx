          ...
          <div className="relative glassmorphism rounded-3xl p-12 border-2 border-primary-300 shadow-2xl overflow-hidden">
            ...
            <div className="relative text-center">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-6">
                ...
                <a href="https://github.com/fyunusa/africa-ai-stack" target="_blank" rel="noopener noreferrer" className="group relative px-8 py-4 bg-white border-3 border-primary-600 text-primary-700 rounded-xl font-bold text-lg hover:bg-primary-50 transition-all hover:scale-105 hover:shadow-xl inline-block">
